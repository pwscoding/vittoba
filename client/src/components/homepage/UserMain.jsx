  ...
  const mainslider = [
    {
      ...
      imgarr: [
        ...
        "./images/productsmain/hp/printer.png",
    ...
    <div className="bg-slate-200">
      ...
      <div>
        <Slide {...slideshowProperties} style={{}}>
          {mainslider.map((single) => {
            const { id, img, imgarr, logo } = single;
            return (
              <div key={id}>
                <div className="w-full">
                  <img
                    className="h-[35vh] sm:h-[40vh] lg:h-[85vh] w-full object-cover relative"
                    src={img}
                    alt="sa"
                  />
                </div>
                <div className="overlay w-screen h-full absolute">
                  ...
                  <div className=" flex justify-between items-center w-screen h-full   max-w-[1536px] ">
                    <div className=" flex items-center flex-col w-screen lg:w-[40%] mx-[17%] lg:mr-[0] lg:ml-[10%] max-w-[1536px]" >
                      {/* <h1 className="mb-4  text-xl md:text-3xl xl:text-5xl font-bold text-white ">{single.name}</h1> */}
                      <img className="mb-2 w-40 sm:w-64" src={logo} alt="ff" />
                      <h1 className="text-center  mx-2 text-[.8rem] sm:text-lg md:text-xl xl:text-3xl font-bold  text-slate-200 ">
                        Merging Precision and Innovation in Printing Solutions
                      </h1>
                      <Link to="/product"><button className="py-1 md:py-3 px-2 md:px-5 bg-black hover:bg-gray-900 hover:scale-110 text-white font-bold rounded-md my-3 md:my-4 text-[.85rem] md:text-xl" style={{ border: "1px solid white" }}>Discover</button></Link>
                    </div>
                    {
                      showmaingrid &&

                      <div className=" grid grid-cols-2  mr-[7%] " >
                        <div className="rounded-md p-4 m-2 bg-[#fff]" style={{ transform: "skew(-15deg)" }}>
                          <img src={imgarr[0]} alt="hp" className="p-3 w-[180px] xl:w-[220px] h-[170px] xl:h-[190px]   rounded-md  object-cover" style={{ transform: "skew(12deg)" }} />
                        </div>
                        <div className="rounded-md p-4 m-2 bg-[#fff]" style={{ transform: "skew(-15deg)" }}>
                          <img src={imgarr[1]} alt="hp" className="p-3 w-[180px] xl:w-[220px]  h-[170px] xl:h-[190px] rounded-md  object-cover" style={{ transform: "skew(12deg)" }} />
                        </div>
                        <div className="ml-[-50px] mr-[70px] rounded-md p-4 m-2 bg-[#fff]" style={{ transform: "skew(-15deg)" }}>
                          <img src={imgarr[2]} alt="hp" className="p-3 w-[180px]  xl:w-[220px] h-[170px] xl:h-[190px] rounded-md  object-cover" style={{ transform: "skew(12deg)" }} />
                        </div>
                        <div className="ml-[-50px] mr-[70px] rounded-md p-4 m-2 bg-[#fff]" style={{ transform: "skew(-15deg)" }}>
                          <img src={imgarr[3]} alt="hp" className="p-3 w-[180px] xl:w-[220px] h-[170px] xl:h-[190px] rounded-md   object-cover" style={{ transform: "skew(12deg)" }} />
                        </div>
      ...
      <div className="flex flex-col lg:flex-row items-center  ">
        <div className="sm:w-full md:w-[700px] lg:w-1/2 bg-slate-900 text-white flex items-center justify-center h-[250px] md:h-[400px]">
          <div className=" mx-14">
            ...
            <button className="self-center p-2 md:p-2  mt-3 md:mt-3 rounded-md text-base md:text-base font-bold bg-slate-700 hover:bg-slate-900" style={{ border: "1px solid white" }}>Contact Us</button>
          </div>
        </div>
        <div className=" sm:w-full md:w-[700px] lg:w-1/2 ">
          ...
          <Slider {...settings} >
            {
              blogData.map((singleproduct, index) => {
                ...
                return (
                  <div key={index} >
                    <div className=" bg-white  px-6 py-4 mx-4">
                      <div className="w-full h-[400px] overflow-hidden"> 
                        <img src={`/uploads/blog/${image}`} alt="singleproduct" className="object-cover w-full h-full" />
                      </div>
                      <h1 className="text-2xl text-center my-4 font-semibold line-clamp-2">{title}</h1>
