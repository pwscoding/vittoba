  ...
  return (
    <div className=' bg-slate-950 text-white'>
      ...
      <div className='flex  justify-around pt-10 pb-0 px-2 md:px-6 lg:px-10 lg:flex-row flex-col '>
        ...
        <div className='   lg:ml-16 mx-auto lg:w-1/4  w-full sm:w-11/12  lg:mb-2 mb-6 bg-slate-100 rounded-xl px-2 py-4' >
          <div>
          <img src={vlogo} alt="main logo" className=" w-4/5 mx-auto max-w-xs" />
          <p className=' text-sm sm:text-[14px] mt-2 md:mt-2 px-3 mx-auto text-justify text-slate-900'>Our professional printer services provide comprehensive support and maintenance for all your printing needs. We understand the importance of having a reliable printing system.</p>
      ...
      <div className='flex md:flex-row flex-col  w-full lg:w-3/4  justify-evenly' >
        ...
        <div className='  mt-4 md:text-left text-center'>
          ...
          <ul className='text-[14px] '>
            <li className='mb-2'>Printing Accessories</li>
            <li className='mb-2'>Ink and Toner Cartridges</li>
            <li className='mb-2'>Printer Parts and Maintenance</li>
            <li className='mb-2'>Printer Supplies and Cleaning </li>
            <li className='mb-2'>Print Management Solutions</li>
          </ul>
        </div>
        ...
        <div className='md:w-1/3 mt-4  md:text-left text-center'>
          ...
          <div className='flex items-center justify-center   md:justify-start mb-4'><img src={map} color='darkblue' className='mr-2  sm:mr-4  w-[20px] sm:w-[22px]' /> <p className='mr-2 text-[12px] sm:text-[14px] '>Shop No.6, Al Raffa S treet Al Souq Al kabeer Bur Dubai, Dubai, UAE</p></div>
            <div className='flex items-center  mb-4 justify-center  md:justify-start  '><img src={call}  color='darkblue'  className='mr-2 sm:mr-4 mb-2  w-[20px] sm:w-[22px]'/><p className='text-[12px] sm:text-[14px]'> +971 50 454 0704 </p></div>
          <div className='flex items-center mb-4 justify-center md:justify-start'>
          <img src={gmail} color='darkblue'  className='mr-2 sm:mr-4  w-[20px] sm:w-[22px]'/>
          <p className='text-[12px] sm:text-[14px]'>sales@vittoballc.com</p> </div>
      ...
      <div className='flex md:flex-row flex-col justify-between sm:px-10 md:px-18 lg:px-24  mt-2  pb-4 pt-3 border-t-2 border-solid border-white lg:border-none' >
        ...
        <h1 className='text-center text-[11px] md:text-[12px] lg:text-[14px]'><a href="">Crafted By Sagar Tech - Technical Solution</a></h1>
      </div>
